...
public class KatharsisAssert {
	...
	/**
	 * Asserts that two objects are equal. If they are not, an {@link AssertionError} without a message is thrown. If
	 ...
	 * {@link AssertionError} is thrown with the given message. If the expected value is infinity then the delta value
	 * is ignored. NaNs are considered equal: <code>assertEquals(Double.NaN, Double.NaN, *)</code> passes
	 * 
	 * @param message
	 *            the identifying message for the {@link AssertionError} ( <code>null</code> okay)
	 * @param expected
	 ...
	 *            the value to check against <code>expected</code>
	 * @param delta
	 *            the maximum delta between <code>expected</code> and <code>actual</code> for which both numbers are
	...
	/**
	 * Asserts that two doubles or floats are equal to within a positive delta. If they are not, an
	 * {@link AssertionError} is thrown. If the expected value is infinity then the delta value is ignored.NaNs are
	...
	/**
	 * Asserts that two objects refer to the same object. If they are not, an {@link AssertionError} is thrown with the
	 * given message.
	 * 
	 * @param message
	 *            the identifying message for the {@link AssertionError} ( <code>null</code> okay)
	...
	/**
	 * Asserts that two objects refer to the same object. If they are not the same, an {@link AssertionError} without a
	 * message is thrown.
	 * 
	 * @param expected
	 *            the expected object
