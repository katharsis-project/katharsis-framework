...
public class AnyUtils {
	 ...
	 */
	public static void setValue(AnyTypeObject dataObject, Object value) {
		MetaDataObject meta = MetaLookup.INSTANCE.getMeta(dataObject.getClass()).asDataObject();
		if (value == null) {
			...
			for (MetaAttribute attr : meta.getAttributes()) {
				if (value != null && attr.getType().getImplementationClass().isAssignableFrom(value.getClass())) {
	 ...
	 * @param attributeName
	 *            the attribute name
	 * @return the meta attribute or <code>null</code> if attributeName is <code>null</code>.
	 */
	private static MetaAttribute getMetaAttribute(AnyTypeObject dataObject, String attributeName) {
	 ...
	 * @param attributeName
	 *            the attribute name
	 * @return the java type name of the attribute or <code>null</code> if attributeName is <code>null</code>.
	 */
	public static String getType(AnyTypeObject dataObject, String attributeName) {
		MetaAttribute attr = getMetaAttribute(dataObject, attributeName);
		if (attr == null)
			return null;
	 ...
	 * @param attributeName
	 *            the attribute name
	 * @return the value of the attribute or <code>null</code> if attributeName is <code>null</code>.
	 */
	public static Object getValue(AnyTypeObject dataObject, String attributeName) {
		MetaAttribute attr = getMetaAttribute(dataObject, attributeName);
		if (attr == null)
			return null;
	 ...
	 * @throw IllegalArgumentException if value is <code>null</code> or no corresponding attribute can be found.
	 */
