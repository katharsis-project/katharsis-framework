...
@Transactional
public class JpaEntityRepositoryTest extends AbstractJpaTest {
	...
	public void setupRepo() {
		repo = new JpaEntityRepository<TestEntity, Long>(module, TestEntity.class);
	}

	@Test
	public void testGetEntityType() throws InstantiationException, IllegalAccessException {
		Assert.assertEquals(TestEntity.class, repo.getEntityType());
	}
	...
	@Test(expected = UnsupportedOperationException.class)
	public void testGroupingNotSupported() throws InstantiationException, IllegalAccessException {
		findAll("group[test]", "bla");
	}
