...
public class ContainerSerializerTest extends BaseSerializerTest {
    ...
    @Test
    public void onSimpleObjectWithNullValueShouldIncludeAttributes() throws Exception {
        // GIVEN
        Project project = new Project();
        ...
        // THEN
        assertThatJson(result).node("attributes.name").isPresent();
    }
    ...
    public void onIncludedFieldsInParamsShouldContainIncludedList() throws Exception {
        ...
        // WHEN
        String result = sut.writeValueAsString(new Container(project, new ResourceResponseContext(new JsonApiResponse(), jsonPath, new QueryParamsAdapter(queryParams))));
    ...
    public void onIncludedRelationshipInParamsShouldContainIncludedList() throws Exception {
        ...
        QueryParamsBuilder queryParamsBuilder = new QueryParamsBuilder(new DefaultQueryParamsParser());
        QueryParams queryParams = queryParamsBuilder.buildQueryParams(Collections.singletonMap("fields[tasks]", Collections.singleton("project")));
        JsonPath jsonPath = new PathBuilder(resourceRegistry).buildPath("/tasks");

        // WHEN
        String result = sut.writeValueAsString(new Container(task, new ResourceResponseContext(new JsonApiResponse(), jsonPath, new QueryParamsAdapter(queryParams))));
    ...
    public void onNestedAttributesShouldSerializeCorrectly() throws Exception {
        // GIVEN
        Pojo pojo = new Pojo();
        pojo.setOtherPojo(new OtherPojo().setValue("some value"));
        ...
        // WHEN
        String result = sut.writeValueAsString(new Container(pojo, new ResourceResponseContext(new JsonApiResponse(), jsonPath, new QueryParamsAdapter(queryParams))));
