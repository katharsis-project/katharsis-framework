# Katharsis build POM v2.6.0 git changelog
...
2016-08-23    #93 loop over resource properties that are an iterable (Nick Mitchell)  
2016-08-23    #93 remove reference from test (Nick Mitchell)  
...
2016-08-19    #85 reduced log level when running jacoco (Patryk Orwat)  
2016-08-19    #85 fixed jacoco (Patryk Orwat)  
2016-08-19    #85 trying to get around 4MB log limit (Patryk Orwat)  
2016-08-19    #85 sonar travis integration java fix (Patryk Orwat)  
2016-08-19    #85 added sonar travis integration (Patryk Orwat)  
