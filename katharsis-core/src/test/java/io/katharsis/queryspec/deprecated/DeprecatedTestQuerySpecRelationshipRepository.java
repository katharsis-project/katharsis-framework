...
public class DeprecatedTestQuerySpecRelationshipRepository extends QuerySpecRelationshipRepository<Task, Long, Project, Long> {

	public DeprecatedTestQuerySpecRelationshipRepository() {
