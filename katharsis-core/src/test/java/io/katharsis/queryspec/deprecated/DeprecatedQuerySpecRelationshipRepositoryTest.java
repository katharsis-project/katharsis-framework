...
public class DeprecatedQuerySpecRelationshipRepositoryTest extends AbstractQuerySpecTest {

	@Test
	public void test() {
		RegistryEntry<?> registryEntry = resourceRegistry.getEntry(Task.class);
		DeprecatedTestQuerySpecRelationshipRepository repo = (DeprecatedTestQuerySpecRelationshipRepository) registryEntry
