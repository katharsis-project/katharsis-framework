...
public class AnnotationResourceInformationBuilder implements ResourceInformationBuilder {
    ...
    private static AnnotatedResourceField mergeAnnotations(AnnotatedResourceField fromField, AnnotatedResourceField fromMethod) {
        ...
        return new AnnotatedResourceField(fromField.getJsonName(), fromField.getUnderlyingName(), fromField.getType(), fromField.getGenericType(), annotations);
    }
    ...
    private Set<AnnotatedResourceField> getBasicFields(List<AnnotatedResourceField> classFields, AnnotatedResourceField idField,
    ...
    static class ResourceFieldWrapper {
