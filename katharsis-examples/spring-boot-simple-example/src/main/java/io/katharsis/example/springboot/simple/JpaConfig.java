...
public class JpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean getLocalContainerEntityManagerFactoryBean() {
		...
		bean.setPackagesToScan(ScheduleEntity.class.getPackage().getName());
		bean.setDataSource(testDataSource());
		bean.setPersistenceUnitName("TEST_SPRING");
		return bean;
	}
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { ScheduleEntity.class.getPackage().getName() });
