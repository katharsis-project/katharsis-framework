...
public class KatharsisHandlerFactory {
	...
	public static KatharsisHandler create(@NonNull String packagesToScan, @NonNull String webPath) {
	...
	public static KatharsisHandler create(@NonNull String packagesToScan, @NonNull String webPath,
			@NonNull ObjectMapper objectMapper, @NonNull ParameterProviderFactory parameterProviderFactory) {
	...
	private static RequestDispatcher createRequestDispatcher(@NonNull ObjectMapper objectMapper,
			@NonNull ModuleRegistry moduleRegistry, @NonNull ExceptionMapperRegistry exceptionMapperRegistry,
	...
	public static ModuleRegistry buildModuleRegistry(@NonNull ObjectMapper objectMapper, @NonNull String packageToScan) {
